...
import io.korus.dev.DevModeManager;
...
//                devManager.startWatching();
                Runtime.getRuntime().addShutdownHook(new Thread(() -> {
                    ...
                    devManager.stop();
                    server.stop();
                    logger.info("c.k.f.KorusApplication", "KorusApplication shutdown completed");
                }));
            ...
            errorLogger.error("c.k.f.KorusApplication", "KorusApplication run failed: " + e.getMessage());
            e.printStackTrace();
